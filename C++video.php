...
<div class="container" style="background-color:black; margin-top:100px; margin-bottom:40px; padding:20px;">
...
<div class="embed-responsive embed-responsive-21by9">
  ...
  <iframe class="embed-responsive-item" src="images/videoC++1.mp4"></iframe>
</div>
</div>
...
<div class="embed-responsive embed-responsive-21by9">
  ...
  <iframe class="embed-responsive-item" src="images/videoC++2.mp4"></iframe>
</div>
</div>
...
<div class="embed-responsive embed-responsive-21by9">
  ...
  <iframe class="embed-responsive-item" src="images/videoC++3.mp4"></iframe>
</div>
</div>
</div>
...
<div class="col-sm-12">
<a href="courseConfirmation.php?coursename=CPP"><button class="btn btn-primary"><h4>Enroll Now!</h4></button></a>
</div>
</div>
</div>
        <!-- Footer -->
